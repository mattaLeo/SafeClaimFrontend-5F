...
export class Perizie {
  ...
  private praticheLink = 'https://solid-giggle-wrrww94466w43gpjq-8000.app.github.dev/';
  // Porta 7000 → sinistri (MongoDB)
  private sinistriLink = 'https://solid-giggle-wrrww94466w43gpjq-7000.app.github.dev/';
