...
export class Perizie {
  ...
  private praticheLink = 'https://studious-enigma-jjjxx4995xp7cppvr-8000.app.github.dev/';
  // Porta 7000 → sinistri (MongoDB)
  private sinistriLink = 'https://studious-enigma-jjjxx4995xp7cppvr-7000.app.github.dev/';
